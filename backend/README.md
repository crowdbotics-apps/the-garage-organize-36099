...
## Project Structure
    ...
    ├── the_garage_organize_36099  # Django project configurations
...
1. Clone this repo and `cd the_garage_organize_36099`
...
2. Clone this repo and `cd the_garage_organize_36099`
